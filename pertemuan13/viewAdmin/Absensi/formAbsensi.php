...
if(isset($_POST['simpan'])) {
    ...
    foreach ($_POST['status'] as $id_mhs => $status) {
        ...
        $sql = "INSERT INTO absensi (id_mahasiswa, id_kelas, id_matkul, semester, pertemuan_ke, status, keterangan, tanggal) VALUES ('$id_mhs', '$id_matkul', '$semester', '$pertemuan', '$status', '$ket', '$tanggal')";
        $conn->query($sql);
        $sukses = true;
    }
    ...
    <form action="" method="POST">
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                <select name="id_matkul" class="form-control" id="" required>
                    <option value="">-- Pilih --</option>
                    <?php
            ...
            <div class="col-md-2">
                ...
                <select name="semester" class="form-control" required id="">
            ...
            <div class="col-md-2">
                ...
                <select name="pertemuan" class="form-control" id="" required>
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $row['namaMhs'] ?></td>
                    <td>
                        <select name="status[<?= $row['id'] ?>]" class="form-select" required id="">
                    ...
                    <td>
                        <input type="text" name="keterangan[<?= $row['id'] ?>]" id="" class="form-control">
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
