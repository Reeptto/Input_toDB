...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE jadwal_kuliah SET id_kelas='$id_kelas', id_matkul='$id_matkul', id_dosen='$id_dosen', id_hari='$id_hari', id_jam_kuliah='$id_jam_kuliah', id_ruangan='$id_ruangan', semester='$semester', tahun_ajaran='$tahun_ajaran' WHERE id ='$id'";
